...
* Display the table
  ...
  METHOD on_user_command.
    ...
    IF mv_executed = 'X'.
      MESSAGE 'Please do not execute repeatedly.' TYPE 'S' DISPLAY LIKE 'E'.
      EXIT.
    ENDIF.
  ...
  METHOD generate_cross_company_fidoc.
    ...
    ELSE.
      ...
      IF obj_key IS NOT INITIAL AND obj_key NE '$'.
        ...
        SET PARAMETER ID: 'BLN' FIELD obj_key+0(10),
                          'BUK' FIELD obj_key+10(4),
                          'GJR' FIELD obj_key+14(4).
        TRY.
          ...
          CATCH cx_sy_authorization_error INTO DATA(lx_error).
            ...
            RETURN.
        ENDTRY.
        MESSAGE |Document { obj_key } posted successfully.| TYPE 'S'.
        EXIT.
      ELSE.
